...
PosModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([user_entity_1.User, dish_entity_1.Dish, order_entity_1.Order, contain_entity_1.Contain, payment_entity_1.Payment])],
        providers: [user_service_1.UserService, dish_service_1.DishService, order_service_1.OrderService, contain_service_1.ContainService, payment_service_1.PaymentService,],
